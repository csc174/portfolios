...
<body>
	...
	<div class="section" id="mel-preview">
		<div class="container">
			<div class="row">
				<div class="col s3"><img class="materialboxed" src="images/mel-headshot.jpg" width="200">
				</div>
				...
				<div class="col s9">
					...
					<a class="btn" href="includes/mel.php">Resume</a> <a class="btn" href="https://www.linkedin.com/in/melaniedookharan/">LinkedIn</a> <a class="btn" href="http://www.melanie-dookharan.com">Portfolio</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section" id="tarin-preview">
		<div class="container">
			<div class="row">
				<div class="col s3"><img class="materialboxed" src="images/tarin-headshot.jpg" width="200">
				</div>
				...
				<div class="col s9">
					...
					<span style="display: inline"><a class="red lighten-2 btn" href="includes/tarin.php">Resume</a> <a class="red lighten-2 btn" href="https://www.linkedin.com/in/tarinrickett">LinkedIn</a> <a class="red lighten-2 btn" href="http://www.tarinrickett.com">Portfolio</a></span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section" id="kalila-preview">
		<div class="container">
			<div class="row">
				<div class="col s3"><img class="materialboxed" src="images/kalila-headshot.jpg" width="200">
				</div>
				...
				<div class="col s9">
					...
					<span style="display: inline"><a class="amber darken-1 btn" href="includes/kalila.php">Resume</a> <a class="amber darken-1 btn">LinkedIn</a> <a class="amber darken-1 btn">Portfolio</a></span>
				</div>
			</div>
		</div>
	</div>
